...
import bowlNoodlesSize from '../icons/OrderInfo/bowlNoodlesSize.svg'
...
function NoodlesOrder({ selectedOptions, handleSize, handleIngridients }) {

    return(

        <div className='order-main'>
                   <p className='soup-title titles'>Noodle bowl size</p>
            <div className="sizing">
             
                
                    <div onClick={() => handleSize('small')}
    className={selectedOptions.Size === 'small' ? 'sizing-item selected-option' : 'sizing-item'}> <img src={bowlNoodlesSize} /> <p>small</p> </div>
                    <div onClick={() => handleSize('medium')}
    className={selectedOptions.Size === 'medium' ? 'sizing-item selected-option' : 'sizing-item'}> <img src={bowlNoodlesSize} /> <p>medium</p> </div>
                    <div onClick={() => handleSize('large')}
    className={selectedOptions.Size === 'large' ? 'sizing-item selected-option' : 'sizing-item'}> <img src={bowlNoodlesSize} /> <p>large</p> </div>
