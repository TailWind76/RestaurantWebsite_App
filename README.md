...
## How to Use
You can easily view our demo application by simply following the link (View Demo: https://TailWind76.github.io/RestaurantWebsite_App) or by cloning the repository and opening the application in your browser.
...
# RestaurantWebsite React приложение
...
## Как использовать
Вы можете легко просмотреть наше демонстрационное приложение, просто перейдя по ссылке (Просмотреть Demo:  https://TailWind76.github.io/RestaurantWebsite_App) или клонируя репозиторий и открыв приложение в своем браузере
